...
public class UploadUtils {
	...
	public static UploadUtils getInstance(ServletContext context) {
		if (utils == null) utils = new UploadUtils(context);
		return utils;
	}
	...
	public String makeFileUploadName(String calcPath, String savedName) throws IOException {
		...
		} else thumnail = uploadPath + calcPath + File.separator + savedName;
	...
	public void mkDir(String... path) {
		...
		if (new File(finalPath).exists()) return;
	...
	public HttpHeaders getHeader(String fileName) {
		...
		try {
			...
			if (mType != null) header.setContentType(mType);
			else {
